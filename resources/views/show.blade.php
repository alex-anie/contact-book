...
<main class="max-w-2xl mx-auto p-6 bg-white shadow rounded-xl space-y-6 mt-4">
    ...
    <section class="flex items-center gap-4 border-b pb-4">
        ...
        <div>
            <p class="text-xl font-semibold text-gray-800">Emily Sande</p>
        </div>
    </section>
    ...
    <div class="space-y-2">
        ...
        <div>
            <p class="text-gray-700 leading-relaxed">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam libero commodi enim distinctio maxime iusto totam iste, nobis vero sit, veritatis neque excepturi, cumque velit facilis corrupti praesentium obcaecati minus.
            </p>
        </div>
    </div>
</main>
